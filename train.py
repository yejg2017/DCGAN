...
lsun_image_path = '/home/yejg/tensorflow/DCGAN/data/train/'
lsun_images = []
...
for epoch in range(n_epochs):
    ...
    for start, end in zip(
        ...
        if np.mod(iterations, 100) == 0:
            ...
            save_visualization(generated_samples, (14,14), save_path='/home/yejg/tensorflow/DCGAN/data'+'/vis/sample_'+str(iterations//100)+'.jpg')
